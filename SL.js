...
const brownBlock = document.querySelectorAll('.main-brown')
...
const winCondition = () => {
  if (
    ...
    greenTilesMatch.length === 35 &&
    magentaTilesMatch.length === 19 &&
  ...
  for (i = 0; i < tiles.length; i++)
    tiles[i].addEventListener('click', (e) => {
      if (
        ...
        e.target.classList.contains('main-brown')
      )
        return
